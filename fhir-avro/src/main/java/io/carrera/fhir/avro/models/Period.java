...
public class Period extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 3067166204934672163L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Period\",\"namespace\":\"io.carrera.fhir.avro.models\",\"fields\":[{\"name\":\"id\",\"type\":[\"null\",\"string\"]},{\"name\":\"extension\",\"type\":[\"null\",{\"type\":\"array\",\"items\":{\"type\":\"record\",\"name\":\"Extension\",\"fields\":[{\"name\":\"id\",\"type\":[\"null\",\"string\"]},{\"name\":\"extension\",\"type\":[\"null\",{\"type\":\"array\",\"items\":\"Extension\"}]},{\"name\":\"url\",\"type\":[\"null\",\"string\"]}]}}]},{\"name\":\"start\",\"type\":[\"null\",{\"type\":\"int\",\"logicalType\":\"date\"},{\"type\":\"long\",\"logicalType\":\"local-timestamp-micros\"}]},{\"name\":\"end\",\"type\":[\"null\",{\"type\":\"int\",\"logicalType\":\"date\"},{\"type\":\"long\",\"logicalType\":\"local-timestamp-micros\"}]}]}");
...
static {
   ...
   */
  public Period(java.lang.CharSequence id, java.util.List<io.carrera.fhir.avro.models.Extension> extension, java.lang.Object start, java.lang.Object end) {
    this.id = id;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 2: start = value$; break;
    case 3: end = value$; break;
    default: throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Period>
    ...
    /**
      ...
      * @return This builder.
      */
    public io.carrera.fhir.avro.models.Period.Builder setExtension(java.util.List<io.carrera.fhir.avro.models.Extension> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.carrera.fhir.avro.models.Period.Builder clearExtension() {
      extension = null;
    ...
    public Period build() {
      try {
        ...
        record.start = fieldSetFlags()[2] ? this.start :  defaultValue(fields()[2]);
        record.end = fieldSetFlags()[3] ? this.end :  defaultValue(fields()[3]);
        return record;
