...
public class Date extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 5060949977786411645L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Date\",\"namespace\":\"io.carrera.fhir.avro.models\",\"fields\":[{\"name\":\"value\",\"type\":[{\"type\":\"record\",\"name\":\"XsDate\",\"fields\":[{\"name\":\"value\",\"type\":{\"type\":\"int\",\"logicalType\":\"date\"}}]},{\"type\":\"record\",\"name\":\"XsYearMonth\",\"fields\":[{\"name\":\"year\",\"type\":\"int\"},{\"name\":\"month\",\"type\":\"int\"}]},{\"type\":\"record\",\"name\":\"XsYear\",\"fields\":[{\"name\":\"value\",\"type\":\"int\"}]}]}]}");
...
static {
   ...
   */
  public static io.carrera.fhir.avro.models.Date.Builder newBuilder() {
    return new io.carrera.fhir.avro.models.Date.Builder();
  }
   ...
   * @return A new Date RecordBuilder
   */
  public static io.carrera.fhir.avro.models.Date.Builder newBuilder(io.carrera.fhir.avro.models.Date.Builder other) {
    if (other == null) {
      return new io.carrera.fhir.avro.models.Date.Builder();
    } else {
      return new io.carrera.fhir.avro.models.Date.Builder(other);
    }
  }
   ...
   * @return A new Date RecordBuilder
   */
  public static io.carrera.fhir.avro.models.Date.Builder newBuilder(io.carrera.fhir.avro.models.Date other) {
    if (other == null) {
      return new io.carrera.fhir.avro.models.Date.Builder();
    } else {
      return new io.carrera.fhir.avro.models.Date.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Date>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(io.carrera.fhir.avro.models.Date.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(io.carrera.fhir.avro.models.Date other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.value)) {
        this.value = data().deepCopy(fields()[0].schema(), other.value);
    ...
    /**
      ...
      * @return This builder.
      */
    public io.carrera.fhir.avro.models.Date.Builder setValue(java.lang.Object value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.carrera.fhir.avro.models.Date.Builder clearValue() {
      value = null;
