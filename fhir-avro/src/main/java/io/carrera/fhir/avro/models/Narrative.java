...
public class Narrative extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -7554294907916487361L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Narrative\",\"namespace\":\"io.carrera.fhir.avro.models\",\"fields\":[{\"name\":\"id\",\"type\":[\"null\",\"string\"]},{\"name\":\"status\",\"type\":[\"null\",\"string\"]},{\"name\":\"div\",\"type\":\"string\"}]}");
   ...
   */
  public Narrative(java.lang.CharSequence id, java.lang.CharSequence status, java.lang.CharSequence div) {
    this.id = id;
    this.status = status;
    this.div = div;
  }
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 2: div = (java.lang.CharSequence)value$; break;
    default: throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Narrative>
    ...
    private Builder(io.carrera.fhir.avro.models.Narrative.Builder other) {
      ...
      if (isValidValue(fields()[2], other.div)) {
        this.div = data().deepCopy(fields()[2].schema(), other.div);
    ...
    public Narrative build() {
      try {
        ...
        record.div = fieldSetFlags()[2] ? this.div : (java.lang.CharSequence) defaultValue(fields()[2]);
        return record;
