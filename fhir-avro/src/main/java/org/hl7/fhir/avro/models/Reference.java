...
public class Reference extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -2579920563172148138L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Reference\",\"namespace\":\"org.hl7.fhir.avro.models\",\"fields\":[{\"name\":\"reference\",\"type\":\"string\"}]}");
   ...
   */
  public static org.hl7.fhir.avro.models.Reference.Builder newBuilder() {
    return new org.hl7.fhir.avro.models.Reference.Builder();
  }
   ...
   * @return A new Reference RecordBuilder
   */
  public static org.hl7.fhir.avro.models.Reference.Builder newBuilder(org.hl7.fhir.avro.models.Reference.Builder other) {
    if (other == null) {
      return new org.hl7.fhir.avro.models.Reference.Builder();
    } else {
      return new org.hl7.fhir.avro.models.Reference.Builder(other);
    }
  }
   ...
   * @return A new Reference RecordBuilder
   */
  public static org.hl7.fhir.avro.models.Reference.Builder newBuilder(org.hl7.fhir.avro.models.Reference other) {
    if (other == null) {
      return new org.hl7.fhir.avro.models.Reference.Builder();
    } else {
      return new org.hl7.fhir.avro.models.Reference.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Reference>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(org.hl7.fhir.avro.models.Reference.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(org.hl7.fhir.avro.models.Reference other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.reference)) {
        this.reference = data().deepCopy(fields()[0].schema(), other.reference);
    ...
    /**
      ...
      * @return This builder.
      */
    public org.hl7.fhir.avro.models.Reference.Builder setReference(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.hl7.fhir.avro.models.Reference.Builder clearReference() {
      reference = null;
