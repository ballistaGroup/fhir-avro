...
public class result_record extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -7992517242522864647L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"result_record\",\"namespace\":\"org.hl7.fhir.avro.models\",\"fields\":[{\"name\":\"reference\",\"type\":\"string\"},{\"name\":\"display\",\"type\":\"string\"}]}");
   ...
   */
  public static org.hl7.fhir.avro.models.result_record.Builder newBuilder() {
    return new org.hl7.fhir.avro.models.result_record.Builder();
  }
   ...
   * @return A new result_record RecordBuilder
   */
  public static org.hl7.fhir.avro.models.result_record.Builder newBuilder(org.hl7.fhir.avro.models.result_record.Builder other) {
    if (other == null) {
      return new org.hl7.fhir.avro.models.result_record.Builder();
    } else {
      return new org.hl7.fhir.avro.models.result_record.Builder(other);
    }
  }
   ...
   * @return A new result_record RecordBuilder
   */
  public static org.hl7.fhir.avro.models.result_record.Builder newBuilder(org.hl7.fhir.avro.models.result_record other) {
    if (other == null) {
      return new org.hl7.fhir.avro.models.result_record.Builder();
    } else {
      return new org.hl7.fhir.avro.models.result_record.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<result_record>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(org.hl7.fhir.avro.models.result_record.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(org.hl7.fhir.avro.models.result_record other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.reference)) {
        this.reference = data().deepCopy(fields()[0].schema(), other.reference);
    ...
    /**
      ...
      * @return This builder.
      */
    public org.hl7.fhir.avro.models.result_record.Builder setReference(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.hl7.fhir.avro.models.result_record.Builder clearReference() {
      reference = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public org.hl7.fhir.avro.models.result_record.Builder setDisplay(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.hl7.fhir.avro.models.result_record.Builder clearDisplay() {
      display = null;
